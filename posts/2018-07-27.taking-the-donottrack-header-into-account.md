...
Let's assume that the 2 choices you have are _basic_ and _full_, then, in the middleware, you would create the cookie and assign it the _basic_ value if the user has DNT.

You view could look like this
